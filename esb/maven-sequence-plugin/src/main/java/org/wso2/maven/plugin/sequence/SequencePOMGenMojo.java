...
public class SequencePOMGenMojo extends AbstractPOMGenMojo {
	...
	protected void addPlugins(MavenProject artifactMavenProject, Artifact artifact) {
		Plugin plugin = CAppMavenUtils.createPluginEntry(artifactMavenProject,"org.wso2.maven","maven-sequence-plugin",WSO2MavenESBPluginConstantants.MAVEN_SEQUENCE_PLUGIN_VERSION,true);
