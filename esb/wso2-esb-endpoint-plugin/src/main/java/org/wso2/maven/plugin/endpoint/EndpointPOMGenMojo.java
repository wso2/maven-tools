...
public class EndpointPOMGenMojo extends AbstractPOMGenMojo {
	...
	protected void addPlugins(MavenProject artifactMavenProject, Artifact artifact) {
		Plugin plugin = CAppMavenUtils.createPluginEntry(artifactMavenProject,"org.wso2.maven","maven-endpoint-plugin",WSO2MavenESBPluginConstantants.MAVEN_ENDPOINT_PLUGIN_VERSION,true);
