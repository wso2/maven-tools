...
/**
 * This is the Maven Mojo used for datasource resources to be copied to the output directory in the resource-process
 * phase.
 */
@Mojo(name="package-datasource")
public class DataSourceMojo extends AbstractMojo {
