...
public class BundleArtifact extends Bundle {
    ...
    protected static Bundle getBundleArtifact(String bundleArtifactDefinition, Bundle bundleArtifact) throws MojoExecutionException {
    ...
    public static Bundle getBundleArtifact(String bundleArtifactDefinition) throws MojoExecutionException {
        return getBundleArtifact(bundleArtifactDefinition, new Bundle());
    }
}
*/
