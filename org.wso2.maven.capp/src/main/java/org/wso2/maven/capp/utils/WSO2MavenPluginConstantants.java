...
public class WSO2MavenPluginConstantants {
	public static final String MAVEN_SYNAPSE_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_AXIS2_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_DATA_SERVICE_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_ENDPOINT_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_GADGET_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_JAXWS_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_CARBON_UI_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_LOCALENTRY_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_PROXY_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_SEQUENCE_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_WAR_PLUGIN_VERSION="2.1.0";
	public static final String MAVEN_BPEL_PLUGIN_VERSION="2.1.0";
	...
	public static final String WSO2_QOS_VERSION = "1.1.0";
	public static final String WSO2_GENERAL_PROJECT_VERSION = "2.1.0";
	public static final String MAVEN_ANALYTICS_PLUGIN_VERSION="1.0.0-SNAPSHOT";
	...
	public static final String MAVEN_INBOUND_ENDPOINT_PLUGIN_VERSION = "1.0.0";
