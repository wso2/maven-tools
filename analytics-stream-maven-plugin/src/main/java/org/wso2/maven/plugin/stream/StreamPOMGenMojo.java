...
public class StreamPOMGenMojo extends AbstractPOMGenMojo {
	...
	protected void addPlugins(MavenProject artifactMavenProject, Artifact artifact) {
		Plugin plugin = CAppMavenUtils.createPluginEntry(artifactMavenProject,"org.wso2.maven","analytics-stream-maven-plugin",WSO2MavenPluginConstantants.MAVEN_ANALYTICS_PLUGIN_VERSION,true);
