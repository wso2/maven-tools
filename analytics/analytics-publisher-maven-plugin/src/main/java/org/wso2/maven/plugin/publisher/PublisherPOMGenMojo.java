...
public class PublisherPOMGenMojo extends AbstractPOMGenMojo {
	...
	protected void addPlugins(MavenProject artifactMavenProject, Artifact artifact) {
		Plugin plugin = CAppMavenUtils.createPluginEntry(artifactMavenProject,"org.wso2.maven","analytics-publisher-maven-plugin",WSO2MavenAnalyticsPluginConstantants.MAVEN_ANALYTICS_PLUGIN_VERSION,true);
