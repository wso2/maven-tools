...
/**
 * This is the Maven Mojo used for executionplan resources to be copied to the output
 * directory in the resource-process phase.
 * 
 * @goal package-executionplan
 * 
 */
public class ExecutionMojo extends AbstractMojo {
