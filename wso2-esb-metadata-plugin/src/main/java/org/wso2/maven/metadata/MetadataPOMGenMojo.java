 ...
 */
@Mojo(name = "pom-gen")
public class MetadataPOMGenMojo extends AbstractPOMGenMojo {
     ...
     */
	@Parameter(defaultValue = "${project.build.directory}/artifact")
    ...
    protected void addPlugins(MavenProject artifactMavenProject, Artifact artifact) {
        Plugin plugin = CAppMavenUtils.createPluginEntry(artifactMavenProject,
                ...
                WSO2MavenPluginConstants.WSO2_ESB_METADATA_PLUGIN_VERSION, true);
